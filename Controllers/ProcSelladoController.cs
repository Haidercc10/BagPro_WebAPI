            ...
            var con = from PS in _context.Set<ProcSellado>()
                      ...
                      select new
                      {
                          ...
                          Total = (
                            ...
                            PS.Key.Maquina != "50" && PS.Key.Maquina != "9" && PS.Key.NomStatus == "SELLADO" && PS.Key.Turnos == "DIA" ? (PS.Key.Unidad == "KLS" ? PS.Sum(x => x.PS.Peso) / PS.Key.DivBulto : PS.Sum(x => x.PS.Qty) / PS.Key.DivBulto) * Convert.ToDecimal(PS.Key.Dia) :
                            PS.Key.Maquina != "50" && PS.Key.Maquina != "9" && PS.Key.NomStatus == "SELLADO" && PS.Key.Turnos == "NOCHE" ? (PS.Key.Unidad == "KLS" ? PS.Sum(x => x.PS.Peso) / PS.Key.DivBulto : PS.Sum(x => x.PS.Qty) / PS.Key.DivBulto) * Convert.ToDecimal(PS.Key.Noche) :

                            PS.Key.EnvioZeus == "1" && PS.Key.Turnos == "DIA" && PS.Key.Maquina == "9" ? (PS.Key.Unidad == "KLS" ? PS.Sum(x => x.PS.Peso) / PS.Key.DivBulto : PS.Sum(x => x.PS.Qty) / PS.Key.DivBulto) * ((from wik in _context.Set<Wiketiando>() where wik.Mq == 9 && wik.Codigo == PS.Key.Referencia select wik.Dia).First() != null ?
                                                                                                                                                      (from wik in _context.Set<Wiketiando>() where wik.Mq == 9 && wik.Codigo == PS.Key.Referencia select wik.Dia).First() : Convert.ToDecimal(PS.Key.Dia)) :
                            PS.Key.EnvioZeus == "1" && PS.Key.Turnos == "DIA" && PS.Key.Maquina == "50" ? (PS.Key.Unidad == "KLS" ? PS.Sum(x => x.PS.Peso) / PS.Key.DivBulto : PS.Sum(x => x.PS.Qty) / PS.Key.DivBulto) * ((from wik in _context.Set<Wiketiando>() where wik.Mq == 50 && wik.Codigo == PS.Key.Referencia select wik.Dia).First() != null ?
                                                                                                                                                       (from wik in _context.Set<Wiketiando>() where wik.Mq == 50 && wik.Codigo == PS.Key.Referencia select wik.Dia).First() : Convert.ToDecimal(PS.Key.Dia)) :

                            PS.Key.EnvioZeus == "1" && PS.Key.Turnos == "NOCHE" && PS.Key.Maquina == "9" ? (PS.Key.Unidad == "KLS" ? PS.Sum(x => x.PS.Peso) / PS.Key.DivBulto : PS.Sum(x => x.PS.Qty) / PS.Key.DivBulto) * ((from wik in _context.Set<Wiketiando>() where wik.Mq == 9 && wik.Codigo == PS.Key.Referencia select wik.Noche).First() != null ?
                                                                                                                                                        (from wik in _context.Set<Wiketiando>() where wik.Mq == 9 && wik.Codigo == PS.Key.Referencia select wik.Noche).First() : Convert.ToDecimal(PS.Key.Noche)) :
                            PS.Key.EnvioZeus == "1" && PS.Key.Turnos == "NOCHE" && PS.Key.Maquina == "50" ? (PS.Key.Unidad == "KLS" ? PS.Sum(x => x.PS.Peso) / PS.Key.DivBulto : PS.Sum(x => x.PS.Qty) / PS.Key.DivBulto) * ((from wik in _context.Set<Wiketiando>() where wik.Mq == 50 && wik.Codigo == PS.Key.Referencia select wik.Noche).First() != null ?
                                                                                                                                                         (from wik in _context.Set<Wiketiando>() where wik.Mq == 50 && wik.Codigo == PS.Key.Referencia select wik.Noche).First() : Convert.ToDecimal(PS.Key.Noche)) :

                            PS.Key.EnvioZeus == "0" && PS.Key.Turnos == "DIA" && PS.Key.Maquina == "9" ? (PS.Key.Unidad == "KLS" ? PS.Sum(x => x.PS.Peso) / PS.Key.DivBulto : PS.Sum(x => x.PS.Qty) / PS.Key.DivBulto) * ((from wik in _context.Set<Wiketiando>() where wik.Mq == 9 && wik.Codigo == PS.Key.Referencia select wik.Dia).First() != null ?
                                                                                                                                                      (from wik in _context.Set<Wiketiando>() where wik.Mq == 9 && wik.Codigo == PS.Key.Referencia select wik.Dia).First() : Convert.ToDecimal(PS.Key.Dia)) :
                            PS.Key.EnvioZeus == "0" && PS.Key.Turnos == "DIA" && PS.Key.Maquina == "50" ? (PS.Key.Unidad == "KLS" ? PS.Sum(x => x.PS.Peso) / PS.Key.DivBulto : PS.Sum(x => x.PS.Qty) / PS.Key.DivBulto) * ((from wik in _context.Set<Wiketiando>() where wik.Mq == 50 && wik.Codigo == PS.Key.Referencia select wik.Dia).First() != null ?
                                                                                                                                                       (from wik in _context.Set<Wiketiando>() where wik.Mq == 50 && wik.Codigo == PS.Key.Referencia select wik.Dia).First() : Convert.ToDecimal(PS.Key.Dia)) :

                            PS.Key.EnvioZeus == "0" && PS.Key.Turnos == "NOCHE" && PS.Key.Maquina == "9" ? (PS.Key.Unidad == "KLS" ? PS.Sum(x => x.PS.Peso) / PS.Key.DivBulto : PS.Sum(x => x.PS.Qty) / PS.Key.DivBulto) * ((from wik in _context.Set<Wiketiando>() where wik.Mq == 9 && wik.Codigo == PS.Key.Referencia select wik.Noche).First() != null ?
                                                                                                                                                        (from wik in _context.Set<Wiketiando>() where wik.Mq == 9 && wik.Codigo == PS.Key.Referencia select wik.Noche).First() : Convert.ToDecimal(PS.Key.Noche)) :
                            PS.Key.EnvioZeus == "0" && PS.Key.Turnos == "NOCHE" && PS.Key.Maquina == "50" ? (PS.Key.Unidad == "KLS" ? PS.Sum(x => x.PS.Peso) / PS.Key.DivBulto : PS.Sum(x => x.PS.Qty) / PS.Key.DivBulto) * ((from wik in _context.Set<Wiketiando>() where wik.Mq == 50 && wik.Codigo == PS.Key.Referencia select wik.Noche).First() != null ?
                                                                                                                                                         (from wik in _context.Set<Wiketiando>() where wik.Mq == 50 && wik.Codigo == PS.Key.Referencia select wik.Noche).First() : Convert.ToDecimal(PS.Key.Noche)) : 0
                          ),
                          Registros = PS.Count(),
        ...
        //    int[] rolls = { 842348, 842351, 842353, 842355 ,842362, 842364, 842414, 842303,842429,842365,842366,842367,842406,842407,842408,842409,842410,842411,842412,842413,842321,842322,842323,842325,842327,842330,842332,842336,842340,842346,842350,842352,842354,842357,842361,842363 };
            ...
            var con = from PS in _context.Set<ProcSellado>()
                      ...
                      select new
                      {
                          ...
                          PS.Key.Referencia,
                          PS.Key.NomReferencia,
                          Cantidad = (PS.Key.Unidad == "KLS" ? PS.Sum(x => x.PS.Peso) / PS.Key.DivBulto : PS.Sum(x => x.PS.Qty) / PS.Key.DivBulto),
                          CantidadTotal = (PS.Key.Unidad == "KLS" ? PS.Sum(x => x.PS.Peso) : PS.Sum(x => x.PS.Qty)),
                          PS.Key.Unidad,
                          PS.Key.Turnos,
                          PS.Key.NomStatus,
                          PrecioDia = (
                          ...
                          Total = (
                            PS.Key.Maquina != "50" && PS.Key.Maquina != "9" && PS.Key.EnvioZeus == "1" && PS.Key.NomStatus == "SELLADO" && PS.Key.Turnos == "DIA" ? (PS.Key.Unidad == "KLS" ? PS.Sum(x => x.PS.Peso) / PS.Key.DivBulto : PS.Sum(x => x.PS.Qty) / PS.Key.DivBulto) * Convert.ToDecimal(PS.Key.Dia) :
                            PS.Key.Maquina != "50" && PS.Key.Maquina != "9" && PS.Key.EnvioZeus == "1" && PS.Key.NomStatus == "SELLADO" && PS.Key.Turnos == "NOCHE" ? (PS.Key.Unidad == "KLS" ? PS.Sum(x => x.PS.Peso) / PS.Key.DivBulto : PS.Sum(x => x.PS.Qty) / PS.Key.DivBulto) * Convert.ToDecimal(PS.Key.Noche) :
                            ...
                            PS.Key.EnvioZeus == "0" && PS.Key.Turnos == "NOCHE" && PS.Key.Maquina == "9" ? (PS.Key.Unidad == "KLS" ? PS.Sum(x => x.PS.Peso) / PS.Key.DivBulto : PS.Sum(x => x.PS.Qty) / PS.Key.DivBulto) * ((from wik in _context.Set<Wiketiando>() where wik.Mq == 9 && wik.Codigo == PS.Key.Referencia select wik.Noche).First() != null ?
                                                                                                                                  (from wik in _context.Set<Wiketiando>() where wik.Mq == 9 && wik.Codigo == PS.Key.Referencia select wik.Noche).First() : Convert.ToDecimal(PS.Key.Noche)) :
                            PS.Key.EnvioZeus == "0" && PS.Key.Turnos == "NOCHE" && PS.Key.Maquina == "50" ? (PS.Key.Unidad == "KLS" ? PS.Sum(x => x.PS.Peso) / PS.Key.DivBulto : PS.Sum(x => x.PS.Qty) / PS.Key.DivBulto) * ((from wik in _context.Set<Wiketiando>() where wik.Mq == 50 && wik.Codigo == PS.Key.Referencia select wik.Dia).First() != null ?
                                                                                                                                   (from wik in _context.Set<Wiketiando>() where wik.Mq == 50 && wik.Codigo == PS.Key.Referencia select wik.Dia).First() : Convert.ToDecimal(PS.Key.Noche)) : 0
                          ),
                          Registros = PS.Count(),
                          PesadoEntre = PS.Key.DivBulto,
                      };
...
#pragma warning disable CS8602 // Desreferencia de una referencia posiblemente NULL.
            var con = from PS in _context.Set<ProcSellado>()
                      ...
                      select new
                      {
                          ...
                          PS.NomReferencia,
                          PS.Item,
                          Cantidad = (PS.Unidad == "KLS" ? PS.Peso / PS.DivBulto : PS.Qty / PS.DivBulto),
                          CantidadTotal = PS.Unidad == "KLS" ? PS.Peso : PS.Qty,
                          PS.Unidad,
                          PS.Maquina,
                          PS.Peso,
                          PS.Turnos,
                          ...
                          Total = (
                            ...
                            PS.Maquina != "50" && PS.Maquina != "9" && PS.NomStatus == "SELLADO" && PS.Turnos == "DIA" ? (PS.Unidad == "KLS" ? PS.Peso / PS.DivBulto : PS.Qty / PS.DivBulto) * Convert.ToDecimal(CL.Dia) :
                            PS.Maquina != "50" && PS.Maquina != "9" && PS.NomStatus == "SELLADO" && PS.Turnos == "NOCHE" ? (PS.Unidad == "KLS" ? PS.Peso / PS.DivBulto : PS.Qty / PS.DivBulto) * Convert.ToDecimal(CL.Noche) :

                            PS.EnvioZeus == "1" && PS.Turnos == "DIA" && PS.Maquina == "9" ? (PS.Unidad == "KLS" ? PS.Peso / PS.DivBulto : PS.Qty / PS.DivBulto) * ((from wik in _context.Set<Wiketiando>() where wik.Mq == 9 && wik.Codigo == PS.Referencia select wik.Dia).First() != null ?
                                                                                                                        (from wik in _context.Set<Wiketiando>() where wik.Mq == 9 && wik.Codigo == PS.Referencia select wik.Dia).First() : Convert.ToDecimal(CL.Dia)) :
                            PS.EnvioZeus == "1" && PS.Turnos == "DIA" && PS.Maquina == "50" ? (PS.Unidad == "KLS" ? PS.Peso / PS.DivBulto : PS.Qty / PS.DivBulto) * ((from wik in _context.Set<Wiketiando>() where wik.Mq == 50 && wik.Codigo == PS.Referencia select wik.Dia).First() != null ?
                                                                                                                         (from wik in _context.Set<Wiketiando>() where wik.Mq == 50 && wik.Codigo == PS.Referencia select wik.Dia).First() : Convert.ToDecimal(CL.Dia)) :

                            PS.EnvioZeus == "1" && PS.Turnos == "NOCHE" && PS.Maquina == "9" ? (PS.Unidad == "KLS" ? PS.Peso / PS.DivBulto : PS.Qty / PS.DivBulto) * ((from wik in _context.Set<Wiketiando>() where wik.Mq == 9 && wik.Codigo == PS.Referencia select wik.Noche).First() != null ?
                                                                                                                          (from wik in _context.Set<Wiketiando>() where wik.Mq == 9 && wik.Codigo == PS.Referencia select wik.Noche).First() : Convert.ToDecimal(CL.Noche)) :
                            PS.EnvioZeus == "1" && PS.Turnos == "NOCHE" && PS.Maquina == "50" ? (PS.Unidad == "KLS" ? PS.Peso / PS.DivBulto : PS.Qty / PS.DivBulto) * ((from wik in _context.Set<Wiketiando>() where wik.Mq == 50 && wik.Codigo == PS.Referencia select wik.Noche).First() != null ?
                                                                                                                           (from wik in _context.Set<Wiketiando>() where wik.Mq == 50 && wik.Codigo == PS.Referencia select wik.Noche).First() : Convert.ToDecimal(CL.Noche)) :

                            PS.EnvioZeus == "0" && PS.Turnos == "DIA" && PS.Maquina == "9" ? (PS.Unidad == "KLS" ? PS.Peso / PS.DivBulto : PS.Qty / PS.DivBulto) * ((from wik in _context.Set<Wiketiando>() where wik.Mq == 9 && wik.Codigo == PS.Referencia select wik.Dia).First() != null ?
                                                                                                                        (from wik in _context.Set<Wiketiando>() where wik.Mq == 9 && wik.Codigo == PS.Referencia select wik.Dia).First() : Convert.ToDecimal(CL.Dia)) :
                            PS.EnvioZeus == "0" && PS.Turnos == "DIA" && PS.Maquina == "50" ? (PS.Unidad == "KLS" ? PS.Peso / PS.DivBulto : PS.Qty / PS.DivBulto) * ((from wik in _context.Set<Wiketiando>() where wik.Mq == 50 && wik.Codigo == PS.Referencia select wik.Dia).First() != null ?
                                                                                                                         (from wik in _context.Set<Wiketiando>() where wik.Mq == 50 && wik.Codigo == PS.Referencia select wik.Dia).First() : Convert.ToDecimal(CL.Dia)) :

                            PS.EnvioZeus == "0" && PS.Turnos == "NOCHE" && PS.Maquina == "9" ? (PS.Unidad == "KLS" ? PS.Peso / PS.DivBulto : PS.Qty / PS.DivBulto) * ((from wik in _context.Set<Wiketiando>() where wik.Mq == 9 && wik.Codigo == PS.Referencia select wik.Noche).First() != null ?
                                                                                                                          (from wik in _context.Set<Wiketiando>() where wik.Mq == 9 && wik.Codigo == PS.Referencia select wik.Noche).First() : Convert.ToDecimal(CL.Noche)) :
                            PS.EnvioZeus == "0" && PS.Turnos == "NOCHE" && PS.Maquina == "50" ? (PS.Unidad == "KLS" ? PS.Peso / PS.DivBulto : PS.Qty / PS.DivBulto) * ((from wik in _context.Set<Wiketiando>() where wik.Mq == 50 && wik.Codigo == PS.Referencia select wik.Noche).First() != null ?
                                                                                                                           (from wik in _context.Set<Wiketiando>() where wik.Mq == 50 && wik.Codigo == PS.Referencia select wik.Noche).First() : Convert.ToDecimal(CL.Noche)) : 0
                          ),
